...
public class IronFenceModBlocks {
	...
	public static Block NETHERITE_FENCE_GATE;
	...
	public static void load() {
		...
		NETHERITE_FENCE_GATE = Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(IronFenceMod.MODID, "netherite_fence_gate"), new NetheriteFenceGateBlock());
	}
	...
	public static void clientLoad() {
		...
		NetheriteFenceGateBlock.clientInit();
	}
}
